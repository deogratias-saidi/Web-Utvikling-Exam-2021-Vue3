  ...
  <div class="container-fluid">
    <div class="search p-4 d-flex justify-content-center">
      <div class="input-container d-flex justify-content-center">
        <input type="text" placeholder="Søk" v-model="artistNameSearchString" />
      </div>
    </div>
  ...
  computed: {
    filteredFeed: function () {
      ...
      artistList = artistList.filter(function (artist) {
        if (
          artist.artistName.toLowerCase().indexOf(artistNameSearchString) !== -1 // her bestemer vi vis skal søker etter. vi søker ett artistnavn.
        ) {
          return artist;
        }
      });
